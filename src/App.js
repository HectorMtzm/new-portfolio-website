...
function App() {
  const techData = [
    ...
    {
      name: 'Kubernetes',
      image: 'https://cncf-branding.netlify.app/img/projects/kubernetes/stacked/color/kubernetes-stacked-color.png',
    },
    {
      name: 'MongoDB',
      image: 'https://webimages.mongodb.com/_com_assets/cms/kusbgztbbnnh146q8-MongoDBLogo1.png?auto=format%252Ccompress',
    },
    {
      name: 'MySQL',
